...
public class TimeSlidingWindow {
    public static void main(String[] args) throws Exception {
        ...
        //5.时间滑动窗口，窗口大小6秒，滑动步长3秒
        WindowedStream<WaterSensor, String, TimeWindow> windowDS = keyByDS.window(SlidingProcessingTimeWindows.of(Time.seconds(6), Time.seconds(3)));
