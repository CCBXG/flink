package com.atguigu.state.keyed.ttl;
 ...
 * 针对同一传感器,如果 5秒内 连续的两条水位线数据值都超过10,则输出报警信息侧输出流
 */
public class TTLStateDemo {
    public static void main(String[] args) throws Exception {
        ...
        //5.针对同一传感器,如果 2秒内 连续的两条水位线数据差值超过10,则输出报警信息侧输出流
        ...
        SingleOutputStreamOperator<WaterSensor> processDS = keyByDS.process(new KeyedProcessFunction<String, WaterSensor, WaterSensor>() {
            ...
            public void open(Configuration parameters) throws Exception {
                //设置valueState的过期时间为5秒
                ValueStateDescriptor<Double> descriptor = new ValueStateDescriptor<>("vc-state", Double.class);
